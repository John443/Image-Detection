...
tf.flags.DEFINE_string("data_dir", "D:\processed_data\data", "path to dataset")
...
def main(argv=None):
    ...
    scene_parsing.write_dataset(FLAGS.data_dir)
    ...
    if FLAGS.mode == 'train':
        train_dataset_reader = dataset.BatchDatset('training.tfrecords', FLAGS.batch_size, image_options)
    validation_dataset_reader = dataset.BatchDatset('validation.tfrecords', FLAGS.batch_size, image_options)
